                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            if (data?.topResponsiblePersons != null)
                              Column(
                                children: List.generate(
                                  data!.topResponsiblePersons.length,
                                  (index) {
                                    final person =
                                        data.topResponsiblePersons[index];
                                    return Padding(
                                      ...
                                      child: PersonRankingItem(
                                        rank: person.rank,
                                        name: person.name,
                                        activityCount: person.activityCount,
                                        avatarColor: _getColorFromHex(
                                          person.color,
                                        ),
                                      ),
                                    );
