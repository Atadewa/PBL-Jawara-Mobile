...
class _EditKeluargaPageState extends State<EditKeluargaPage> {
  ...
  late TextEditingController _namaKepalaController;
  late StatusKeluarga _selectedStatus;
  ...
  void initState() {
    super.initState();
    _nomorKKController = TextEditingController(text: widget.keluarga.kk);
    _namaKepalaController = TextEditingController(text: widget.keluarga.nama);
    _selectedStatus = widget.keluarga.status;
    _selectedRumah = '1'; // Default ke rumah pertama
  }
