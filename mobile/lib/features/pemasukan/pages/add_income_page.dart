  ...
  final List<Map<String, dynamic>> _categories = [
    {
      ...
      'textColor': Color(0xFF8200DA),
    },
    {
      'name': 'Dana Bantuan Pemerintah',
      'color': Color(0xFFDBEAFE),
      'textColor': Color(0xFF1347E5),
    },
    {
      'name': 'Sumbangan Swadaya',
      'color': Color(0xFFFFEDD4),
      'textColor': Color(0xFFC93400),
    },
    {
      'name': 'Hasil Usaha Kampung',
      'color': Color(0xFFD0FAE5),
      'textColor': Color(0xFF007955),
    },
    {
